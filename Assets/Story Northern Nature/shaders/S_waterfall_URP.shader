...
Shader "TidalFlask/Waterfall URP"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin][HDR]_BaseColor("Base Color", Color) = (0,0.711586,1,0)
		...
		[ASEEnd]_RipplesBottomCoverageFalloff("Ripples Bottom Coverage Falloff", Range( 0 , 40)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _BaseColor;
			float _RippleSpeed;
			float _RipplesBottomNoiseScale;
			float _VertexOffset;
			float _RipplesNoiseScale;
			float _NoiseSpeed;
			float _RipplesCoverageAmount;
			float _RipplesCoverageFalloff;
			float _BaseColorContrast;
			float _RipplesBottomHeight;
			float _RipplesBottomCoverageAmount;
			float _RipplesBottomCoverageFalloff;
			float _CutoutValue;
			float _TopFadeAmount;
			float _TopFadeFalloff;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord2 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break62 = texCoord2;
				float2 appendResult63 = (float2(break62.x , ( break62.y + ( _TimeParameters.x * _RippleSpeed ) )));
				...
				float4 lerpResult71 = lerp( float4( ase_worldPos , 0.0 ) , appendResult70 , texCoord68.y);
				float3 worldToObj72 = mul( GetWorldToObjectMatrix(), float4( lerpResult71.xyz, 1 ) ).xyz;
				...
				#endif
				float3 vertexValue = worldToObj72;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float time1 = ( _TimeParameters.x * _NoiseSpeed );
				float2 voronoiSmoothId0 = 0;
				float2 texCoord2 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break62 = texCoord2;
				float2 appendResult63 = (float2(break62.x , ( break62.y + ( _TimeParameters.x * _RippleSpeed ) )));
				...
				float simplePerlin2D19 = snoise( appendResult63*_RipplesBottomNoiseScale );
				simplePerlin2D19 = simplePerlin2D19*0.5 + 0.5;
				float temp_output_52_0 = saturate( pow( (0.0 + (( pow( ( 1.0 - texCoord2.y ) , ( ( 1.0 - _RipplesBottomHeight ) * 50.0 ) ) * simplePerlin2D19 ) - 0.0) * (( _RipplesBottomCoverageAmount * 10.0 ) - 0.0) / (1.0 - 0.0)) , _RipplesBottomCoverageFalloff ) );
				
				float3 switchResult37 = (((ase_vface>0)?(float3(0,0,1)):(float3(0,0,-1))));
				
				float lerpResult39 = lerp( saturate( ( saturate( temp_output_12_0 ) + temp_output_52_0 ) ) , 1.0 , _CutoutValue);
				float temp_output_94_0 = ( 1.0 - texCoord2.y );
				float temp_output_106_0 = pow( temp_output_94_0 , 3.31 );
				
				float3 Albedo = ( _BaseColor * saturate( ( (_BaseColorContrast + (temp_output_12_0 - 0.0) * (1.0 - _BaseColorContrast) / (1.0 - 0.0)) + temp_output_52_0 ) ) ).rgb;
				float3 Normal = switchResult37;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( lerpResult39 * pow( saturate( ( ( ( simplePerlin2D19 * temp_output_94_0 ) + ( temp_output_106_0 + temp_output_106_0 ) ) + _TopFadeAmount ) ) , _TopFadeFalloff ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				float3 break66 = ase_worldPos;
				float2 texCoord2 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break62 = texCoord2;
				float2 appendResult63 = (float2(break62.x , ( break62.y + ( _TimeParameters.x * _RippleSpeed ) )));
				float simplePerlin2D19 = snoise( appendResult63*_RipplesBottomNoiseScale );
				simplePerlin2D19 = simplePerlin2D19*0.5 + 0.5;
...
/*ASEBEGIN
Version=18912
529;475;1906;786;538.918;-70.10089;1;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;115;281.8627,4.765707;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;111;281.8627,4.765707;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;112;281.8627,4.765707;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;TidalFlask/Waterfall URP;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;114;281.8627,4.765707;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;116;281.8627,4.765707;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;113;281.8627,4.765707;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;112;0;4;0
WireConnection;112;1;37;0
WireConnection;112;6;101;0
WireConnection;112;7;83;0
WireConnection;112;8;72;0
ASEEND*/
//CHKSM=A5EB32AA52EBACC4CB44B103C889BECF5EA5C2C9