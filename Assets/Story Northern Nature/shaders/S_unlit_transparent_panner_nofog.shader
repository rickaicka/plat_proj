...
Shader "TidalFlask/Unlit Transparent Panner NoFog"
{
	Properties
	{
		...
		[ASEEnd]_NoiseTilingY("Noise Tiling Y", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord8 = IN.ase_texcoord3.xy * appendResult16 + appendResult13;
				...
				float2 uv_GradientMaskL2 = IN.ase_texcoord3.xy;
				float2 uv_GradientMaskR3 = IN.ase_texcoord3.xy;
				float2 temp_cast_2 = (( _PannerSpeed * _TextureVSNoiseSpeedRatio )).xx;
				float2 appendResult23 = (float2(_NoiseTilingX , _NoiseTilingY));
				float2 texCoord21 = IN.ase_texcoord3.xy * appendResult23 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult16 = (float2(_BaseTextureTilingX , _BaseTextureTilingY));
				float2 appendResult13 = (float2(_BaseTextureStartOffset , 0.0));
				float2 texCoord8 = IN.ase_texcoord2.xy * appendResult16 + appendResult13;
				float2 panner10 = ( 1.0 * _Time.y * temp_cast_0 + texCoord8);
				float2 appendResult57 = (float2(panner10.x , texCoord8.y));
				float4 tex2DNode1 = tex2D( _BaseTexture, appendResult57 );
				float2 uv_GradientMaskL2 = IN.ase_texcoord2.xy;
				float2 uv_GradientMaskR3 = IN.ase_texcoord2.xy;
				float2 temp_cast_1 = (( _PannerSpeed * _TextureVSNoiseSpeedRatio )).xx;
				float2 appendResult23 = (float2(_NoiseTilingX , _NoiseTilingY));
				float2 texCoord21 = IN.ase_texcoord2.xy * appendResult23 + float2( 0,0 );
...
/*ASEBEGIN
Version=18912
149;536;1906;774;1391.633;258.7101;1.347463;True;False
...
Node;AmplifyShaderEditor.SamplerNode;3;-1011.87,579.2657;Inherit;True;Property;_GradientMaskR;Gradient Mask R;6;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;3f569e13e42a44e4cb93da7ad23df2c5;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-1013.17,345.2651;Inherit;True;Property;_GradientMaskL;Gradient Mask L;5;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;981a34570f7fce740ba2a6775b4551bd;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-1020.735,8.053627;Inherit;True;Property;_BaseTexture;Base Texture;0;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;4818bd5d43456574aa1b4d9dde25f0bc;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=643E8D1B97253F1F71B08C79789F9081685431C6